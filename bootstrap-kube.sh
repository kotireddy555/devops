...
then
  ...
  sshpass -p "kubeadmin" scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no k88888888master.lxd:/joincluster.sh /joincluster.sh 2>/tmp/joincluster.log
